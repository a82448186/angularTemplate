...
angular.module("cgBusy")
    .run(["$templateCache", function ($templateCache) {
        $templateCache.put("angular-busy.html",
            ...
            '<div class="cg-busy-default-spinner" style="top: 8px; left: 9px">' +
            //'<div class="bar1"></div>' +
            //'<div class="bar2"></div>' +
            //'<div class="bar3"></div>' +
            //'<div class="bar4"></div>' +
            ...
            '</div>' +
            '</div>');
        $templateCache.put("angular-busy-video.html",
            '<div class="cg-busy-default-wrapper">' +
            '<div style="display: inline-block;margin-top: 150px" >' +
            '<img src="img/loading.gif" alt="" >' +
            '<span style="margin-left: 10px;font-size: 16px">{{$message}}</span>' +
            '</div>' +
            '</div>');
        $templateCache.put("angular-busy-group-img.html",
            '<div class="cg-busy-default-wrapper">' +
